    ...
    <AnimatePresence>
      <div>
        ...
        <div className="flex flex-col px-4 w-dvw">
          <div className="flex flex-row justify-between w-full items-center relative  py-4">
            <div className="">
              <svg
                className="h-8 w-8 fill-neutral-950"
                  ...
                  >
                    <div className="flex flex-col  w-full">
                      <div className="py-4 flex flex-row justify-between items-center relative">
                        <div className="">
                          <svg
                            className="h-8 w-8 fill-neutral-700"
                            xmlns="http://www.w3.org/2000/svg"
                            width="32"
                            height="32"
                            viewBox="0 0 32 32"
                        ...
                        <Dialog.Close>
                          <svg
                            className="fill-neutral-500 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 "
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
      ...
      "
                    ...
                    <Accordion.Root className="flex flex-col">
                      <Accordion.Item className="w-full p-4 bg-neutral-100 font-mono uppercase font-neutral-700">
                        <Accordion.Trigger>Customers</Accordion.Trigger>
